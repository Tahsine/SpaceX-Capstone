...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        select_site = filtered_df[filtered_df['Launch Site'] == entered_site]
        success_count = select_site.groupby(['class'])['Launch Site'].count().reset_index()
...
def get_scatter_chart(select_site, payload_range):
    ...
    if select_site == 'ALL':
        ...
        site_filtered_df = filtered_df[filtered_df['Launch Site'] == select_site]
